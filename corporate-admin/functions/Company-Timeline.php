...
if(isset($_POST['submit'])){
 ...
 if ($type == 'Edit') {
  ...
  company_content_3   = '".addslashes($field3)."'
  where id='".$edit_id."'";   
...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and company_type = 'Timeline' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and company_type = 'Timeline' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      ...
                      <label for="inv_phone">Year</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Long Description</label>
                      <textarea class="form-control" name="field3"><?php echo $rows1->company_content_3;?></textarea>
                      </div>
                      </div>
                    </div>
