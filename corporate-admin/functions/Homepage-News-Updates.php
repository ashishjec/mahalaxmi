...
if(isset($_POST['submit'])){
  ...
  if($_FILES['photo1']['name'] == "") {
    ...
    if(in_array($extension,$allow)){
      ...
      $sql = ($photo1!='')?" homepage_content_6='$photo1' ". ',':'';
    }
...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and homepage_type = 'LatestNewsUpdate' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and homepage_type = 'LatestNewsUpdate' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
 ...
 $select_booking= "SELECT * FROM `$table_name` WHERE id = '29'";
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Headline</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Short Description</label>
                      <input name="field2" type="text" class="form-control"  required=""  value="<?php echo $rows1->homepage_content_2;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Blog Details</label>
                      <textarea id="editor" name="field6" class="form-control"  required=""><?php echo $rows1->homepage_content_5; ?></textarea>
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Date</label>
                      <input name="field3" type="date" class="form-control"  required=""  value="<?php echo $rows1->homepage_content_3;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Caption</label>
                      <input name="field4" type="text" class="form-control"  required=""  value="<?php echo $rows1->homepage_content_4;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
...
$field4 = $rows->homepage_content_3;
$field5 = $rows->homepage_content_4;
...
?>                  
                      ...
                      <td class="center"><?php echo substr("$field2",0,20);?>...</td>
                      <td class="center"><?php echo substr("$field3",0,20);?>...</td>
                      
                      <td class="center"><?php echo substr("$field4",0,20);?></td>
                      <td class="center"><?php echo substr("$field5",0,20);?></td>
