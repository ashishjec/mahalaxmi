...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and homepage_type = 'Business' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and homepage_type = 'Business' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
                ...
                <form id="formID" class="m-t-30" method="POST" action="">
                   <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone"> Icon Name (<a href="https://fontawesome.com/v4.7/icons/" target="_blank">Find Icons</a>)</label>
                      <input name="field3" type="text" class="form-control"  required=""  value="<?php echo $rows1->homepage_content_3;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Link</label>
