...
if(isset($_POST['submit'])){
 ...
 if ($type == 'Edit') {
   ...
   $sql
  bus_type   = 'SingleBusiness',   
  bus_name   = '".addslashes($field1)."',
  bus_desc   = '".addslashes($field2)."',
...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and bus_type = 'SingleBusiness' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and bus_type = 'SingleBusiness' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      ...
                      <label for="inv_phone">Business Name</label>
                      <input name="field1" type="text" class="form-control"  required="" value="<?php echo $rows1->bus_name;?>" >
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Business Description</label>
                      <input name="field2" type="text" class="form-control"  required=""  value="<?php echo $rows1->bus_desc;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Business Link</label>
                      <input name="field3" type="text" class="form-control"  required=""  value="<?php echo $rows1->bus_link;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Activity Image (1020px X 750px)</label>
...
?>                  
                      ...
                      <td class="center">
                        <a href="index.php?action=Business-Edit&name=<?php echo $field2;?>"target="_self" ><i class="fa fa-eye"></i> </a> 
