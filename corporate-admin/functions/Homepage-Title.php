              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="">
                   <div class="row">
                      ...
                      <label for="inv_phone"> Line 1</label>
                      <input name="field1" type="text" class="form-control" id="field1"   value="<?php echo $rows1->homepage_content_1;?>" >
                      ...
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone"> Line 2</label>
                      <input name="field2" type="text" class="form-control" id="field1"   value="<?php echo $rows1->homepage_content_2;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
