...
$sql=$dbconn->prepare($select_enquiry);
 ...
 $select_booking= "SELECT * FROM `$table_name` WHERE id = '10'";
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      ...
                      <label for="inv_phone">Chairman's Name</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Chairman's Designation</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Chairman's Message</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Chairmans's Image (540px X 640px)</label>
                ...
                <table class="table table-hover" id="sample-table-1">
                    <thead class="thead-dark">
                      <tr>
                        ...
                        <th class="center"> Chairman's Name</th>
                        <th class="center">  Chiarman's Designation</th>
                        <th class="center">  Chairman's Message</th>
