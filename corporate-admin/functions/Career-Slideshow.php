...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and career_type = 'Slideshow' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and career_type = 'Slideshow' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <label for="inv_phone">Activity Image (450px X 400px)</label>
