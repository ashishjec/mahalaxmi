...
$select_website= "SELECT * FROM `websites` WHERE  status = 'Active'";
...
$sql=$dbconn->prepare($select_enquiry);
 ...
 $select_bookings= "SELECT * FROM `$table_name` WHERE id = '$edit_id' and status = 'Active' ";
          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             <div class="row">
                      ...
                      <textarea id="editor" name="field2"  ><?php echo $rows1->web_desc;?></textarea>
