...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and cs_type = 'Stream' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and cs_type = 'Stream' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
