...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and homepage_type = 'Website_Groups' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and homepage_type = 'Website_Groups' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
 ...
 $select_booking= "SELECT * FROM `$table_name` WHERE id = '44'";
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Group Content</label>
                      ...
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Group Website</label>
                ...
                <table class="table table-hover" id="sample-table-1">
                    <thead class="thead-dark">
                      <tr>
                        ...
                        <th class="center"> Group Content</th>
