              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="">
                   <div class="row">
                      ...
                      <label for="inv_phone">Group Name</label>
                      <input name="field1" type="text" class="form-control" id="field1"   value="<?php echo $rows1->user_grp_name;?>" >
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Group Role</label>
                      <input name="field2" type="text" class="form-control" id="field2"   value="<?php echo $rows1->user_grp_role;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
