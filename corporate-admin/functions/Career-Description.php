...
if(isset($_POST['submit'])){
  ...
  if($_FILES['photo1']['name'] == "") {
   ...
   $sql
  career_type   = 'Desc',
  career_extra   = '".addslashes($field1)."'
  where id='2'";   
...
$select_enquiry="SELECT * FROM $table_name where id = '2' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where  id = '2' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      ...
                      <textarea name="field1" class="form-control"><?php echo $rows1->career_extra;?></textarea>
