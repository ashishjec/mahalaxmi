...
if(isset($_POST['submit'])){
 ...
 if ($type == 'Edit') {
  ...
  company_content_2   = '".addslashes($field2)."',
  company_content_4   = '".addslashes($field4)."'
  where id='".$edit_id."'";   
...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and company_type = 'Glance' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and company_type = 'Glance' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
 ...
 $select_booking= "SELECT * FROM `$table_name` WHERE id = '23'";
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      ...
                      <label for="inv_phone">Icon</label>
                      <input name="field1" type="text" class="form-control"  required="" value="<?php echo $rows1->company_content_1;?>" >
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Number</label>
                      <input name="field2" type="text" class="form-control"  required=""  value="<?php echo $rows1->company_content_2;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">CSR ICON  </label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Fact</label>
                      <input name="field4" type="text" class="form-control"  required=""  value="<?php echo $rows1->company_content_4;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
...
$field1 = $rows->id;
$field2 = $rows->company_content_1;
$field3 = $rows->company_content_2;
$field4 = $rows->company_content_4;
