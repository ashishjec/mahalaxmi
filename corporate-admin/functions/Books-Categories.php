              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="">
                   <div class="row">
                      ...
                      <label for="inv_phone">Category Name</label>
                      <input name="field1" type="text" class="form-control" id="field1"   value="<?php echo $rows1->bk_cat_name;?>" >
