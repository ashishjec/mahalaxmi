...
if(isset($_POST['submit'])){
 ...
 if ($type == 'Edit') {
  ...
  con_name   = '".addslashes($field1)."',   
  con_address   = '".addslashes($field2)."',
  con_phone   = '".addslashes($field3)."',
  con_email   = '".addslashes($field4)."',
  con_map   = '".addslashes($field5)."'
  where id='".$edit_id."'";   
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="">
                   <div class="row">
                      ...
                      <input name="field1" type="text" class="form-control" id="field1"   value='<?php echo $rows1->con_name;?>' >
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone"> Address</label>
                      <input name="field2" type="text" class="form-control" id="field1"   value='<?php echo $rows1->con_address;?>' >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <input name="field3" type="text" class="form-control" id="field1"   value='<?php echo $rows1->con_phone;?>' >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone"> Email</label>
                      <input name="field4" type="text" class="form-control" id="field1"   value='<?php echo $rows1->con_email;?>' >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone"> Map URL</label>
                      <input name="field5" type="text" class="form-control" id="field1"   value='<?php echo $rows1->con_map;?>' >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
