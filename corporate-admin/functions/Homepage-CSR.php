...
if(isset($_POST['submit1'])){
  ...
  if($_FILES['photo2']['name'] == "") {
    ...
    if(in_array($extension,$allow)){
      ...
      $sql2 = ($photo2!='')?" homepage_content_3='$photo2' ". ',':'';
    }
...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and homepage_type = 'CSR' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and homepage_type = 'CSR' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="modal-body">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Section Image</label>
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">CSR Name</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">CSR One Liner</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">CSR Link</label>
