...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and media_type = 'Media_Coverage' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and media_type = 'Media_Coverage' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Media Coverage Content</label>
                    ...
                    <div class="row">
                      ...
                      <textarea id="editor" name="field3" class="form-control"  required=""><?php echo $rows1->media_content_4; ?></textarea>
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Media Coverage Photo (540px X 640px)</label>
                ...
                <table class="table table-hover" id="sample-table-1">
                    <thead class="thead-dark">
                      <tr>
                        ...
                        <th class="center"> Media Coverage</th>
