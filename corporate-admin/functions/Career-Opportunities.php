...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and career_type = 'Opportunity' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and career_type = 'Opportunity' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <input name="field1" type="date" class="form-control"  required="" value="<?php echo $rows1->career_content_1 ;?>">
                    ...
                    <div class="row">
                      ...
                      <textarea class="form-control" name="field2"><?php echo $rows1->career_content_2 ;?></textarea>
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
...
$field1 = $rows->id;
$field2 = $rows->career_content_2;
$field3 = $rows->career_content_1;
...
?>                  
                      ...
                      <td class="center"><?php echo substr("$field2",0,30);?>...</td>
                       
                      
                      
                       
                      <td class="center">
                        <a href="index.php?action=Career-Applicants&id=<?php echo $field1;?>"target="_self" ><i class="fa fa-eye"></i> </a> 
