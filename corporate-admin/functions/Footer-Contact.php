...
if(isset($_POST['submit'])){
  ...
  f_about   = '".addslashes($field3)."',
  f_address   = '".addslashes($field4)."',
  f_email   = '".addslashes($field5)."',
  f_content   = '".addslashes($field2)."'
  where id='2'";   
...
$sql=$dbconn->prepare($select_enquiry);
 ...
 $select_bookings= "SELECT * FROM `$table_name` WHERE id = '2'";
 ...
 $select_booking= "SELECT * FROM `$table_name` WHERE id = '2'";
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <label for="inv_phone">Contact Number</label>
                      <input name="field3" class="form-control"  required value="<?php echo $rows1->f_about;?>">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Footer Address</label>
                      <input name="field4" class="form-control" required value="<?php echo $rows1->f_address;?>">
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Footer Email</label>
                      <input name="field5" class="form-control" required value="<?php echo $rows1->f_email;?>">
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
