...
if(isset($_POST['submit'])){
  ...
  if($_FILES['photo2']['name'] == "") {
    ...
    if(in_array($extension,$allow)){
      ...
      $sql2= ($photo2!='')?" media_content_6='$photo2' ". ',':'';
    }
 ...
 if ($type == 'Edit') {
  ...
  media_content_4   = '".addslashes($field4)."'
  where id='$edit_id'";   
...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and media_type = 'Latest_News_Update' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and media_type = 'Latest_News_Update' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
         ...
         <form id="formID" class="m-t-30" method="POST" action="">
              ...
              <div class="modal-body">
                   ...
                   <div class="row">
                      ...
                      <input name="fieldA" type="text" class="form-control"  required="" value="<?php echo $rows2->media_content_1;?>" >
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Latest News Content (Word Limit 120)</label>
                      <input name="field1" type="text" class="form-control"  required="" value="<?php echo $rows1->media_content_1;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <textarea id="editor" name="field4" class="form-control"  required=""><?php echo $rows1->media_content_4; ?></textarea>
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>    
                    ...
                    <div class="row">
                      ...
                      <input name="field2" type="date" class="form-control"  required=""  value="<?php echo $rows1->media_content_2;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Sidebar Icon</label>
                      <input name="photo2" type="file" class="form-control"  required="">
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone">Background Image</label>
                      <input name="photo1" type="file" class="form-control"  required="">
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
                ...
                <table class="table table-hover" id="sample-table-1">
                    <thead class="thead-dark">
                      <tr>
                        ...
                        <th class="center"> Latest News Update</th>
...
$field1 = $rows->id;
$field2 = $rows->media_content_1;
$field3 = $rows->media_content_2;
$field4 = $rows->media_content_4;
