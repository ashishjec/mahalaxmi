...
if(isset($_POST['submit'])){
 ...
 if ($type == 'Edit') {
  ...
  sidebar_category_name   = '".addslashes($field1)."',   
  sidebar_category_type   = '".addslashes($field2)."',   
  sidebar_category_icon   = '".addslashes($field3)."'
  where id='".$edit_id."'";   
              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="">
                   <div class="row">
                      ...
                      <input name="field1" type="text" class="form-control" id="field1"   value="<?php echo $rows1->sidebar_category_name;?>" >
                    ...
                    <div class="row">
                      ...
                      <select name="field2" class="form-control">
                        ...
                        <option><?php  echo $rows1->sidebar_category_type;?></option>
                    ...
                    <div class="row">
                      ...
                      <input name="field3" type="text" class="form-control" id="field3"   value="<?php echo $rows1->sidebar_category_icon;?>" >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
                    </div>
...
$field1 = $rows->id;
$field2 = $rows->sidebar_category_name;
$field3 = $rows->sidebar_category_type;
