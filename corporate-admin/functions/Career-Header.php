              ...
              <div class="table-responsive">
                ...
                <form id="formID" class="m-t-30" method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                      ...
                      <input name="field1" type="text" class="form-control" id="field1"   value="<?php echo $rows1->career_extra;?>" >
                    ...
                    <div class="row">
                      <div class="col-md-12">
                      <div class="form-group">
                      <label for="inv_phone"> Homepage Image</label>
                      <input name="photo1" type="file" class="form-control" id="field1"   >
                      <small id="emailHelp" class="form-text text-muted"></small> 
                      </div>
                      </div>
