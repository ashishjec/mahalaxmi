...
$select_enquiry="SELECT * FROM $table_name where status = 'Active' and career_type = 'Applicant' and career_content_4 = '$id' order by id desc";
 ...
 $sql->execute();
        ...
        $select_enquiry = "SELECT * FROM $table_name where status = 'Active' and career_type = 'Applicant' and career_content_4 = '$id' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql=$dbconn->prepare($select_enquiry);
 $sql->execute();
...
$field1 = $rows->id;
$field2 = $rows->career_content_1;
$field3 = $rows->career_content_2;
$field4 = $rows->career_content_3;
$field5 = $rows->career_image;
...
?>                  
                      ...
                      <td class="center">
                        <a href="../assets/img/career/<?php echo $field5;?>"target="_blank" ><i class="fa fa-eye"></i> </a> 
