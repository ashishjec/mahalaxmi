...
$select_blog = "SELECT * FROM media_blog where id = '$id' ";
...
You Are Here > <a href="index.php?page=Media" style="color:#000;">Media</a> > <a style="color:#000;" href="index.php?page=<?php echo $page?>&id=<?php echo $id?>">News Detail</a>
</div>
