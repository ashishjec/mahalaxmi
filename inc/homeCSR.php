...
$select8= "SELECT * FROM `homepage` WHERE id = '23'";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7 col-md-10">
                            <div class="section-heading">
                                <h4 style="font-family: Poppins;"><?php echo $rows8->homepage_content_1 ;?></h4>
                                <p style="font-family: Poppins;">
                                    <?php echo $rows8->homepage_content_2 ;?>
                                </p>
                            </div>
                        </div>
                    </div>
    <div class="row">
        <div class="col-md-6" style="padding-top:20px"><img height="90%" src="assets/img/home/<?php echo $rows8->homepage_content_3 ;?>"></div>
            <div class="col-md-6" style="text-align:center;">                          
                    <!-----Floating CSR CARDS STARTS--->
                      ...
                      <div class="row">
                        <div >
                          <div class="our_solution_category">
                            ...
                            //Select Homepage Title
                            $select21= "SELECT * FROM `homepage` WHERE id = '24'";
                            $sql21=$dbconn->prepare($select21);
                            $sql21->execute();
                            ...
                            ?>                                
                              <div class="solution_card">
                                ...
                                <div class="solu_title">
                                  <h3><?php echo $rows21->homepage_content_1?></h3>
                                </div>
                                <div class="solu_description">
                                  <p>
                                    <?php echo $rows21->homepage_content_2?>
                                  </p>
                                  <button onclick="window.location.href='<?php echo $rows21->homepage_content_4?>'" type="button" class="read_more_btn">Read More</button>
                                </div>
                              </div>
                            ...
                            //Select Homepage Title
                            $select22= "SELECT * FROM `homepage` WHERE id = '25'";
                            $sql22=$dbconn->prepare($select22);
                            $sql22->execute();
                            ...
                            ?> 
                              <div class="solution_card">
                                ...
                                <div class="solu_title">
                                  <h3><?php echo $rows22->homepage_content_1?></h3>
                                </div>
                                <div class="solu_description">
                                  <p>
                                        <?php echo $rows22->homepage_content_2?>
                                  </p>
                                  <button onclick="window.location.href='<?php echo $rows22->homepage_content_4?>'" type="button" class="read_more_btn">Read More</button>
                                </div>
                              </div>
                            </div>
                            <!--  -->
                            ...
                            //Select Homepage Title
                            $select23= "SELECT * FROM `homepage` WHERE id = '26'";
                            $sql23=$dbconn->prepare($select23);
                            $sql23->execute();
                            $wlvd23=$sql23->fetchAll(PDO::FETCH_OBJ);
                            foreach($wlvd23 as $rows23);
                            ...
                            ?> 
                              <div class="solution_card">
                                ...
                                <div class="solu_title">
                                  <h3><?php echo $rows23->homepage_content_1?></h3>
                                </div>
                                <div class="solu_description">
                                  <p>
                                    <?php echo $rows23->homepage_content_2?>
                                  </p>
                                  <button onclick="window.location.href='<?php echo $rows23->homepage_content_4?>'" type="button" class="read_more_btn">Read More</button>
                            ...
                            //Select Homepage Title
                            $select24= "SELECT * FROM `homepage` WHERE id = '27'";
                            $sql24=$dbconn->prepare($select24);
                            $sql24->execute();
                            $wlvd24=$sql24->fetchAll(PDO::FETCH_OBJ);
                            foreach($wlvd24 as $rows24);
                            ...
                            ?> 
                              <div class="solution_card">
                                ...
                                <div class="solu_title">
                                  <h3><?php echo $rows24->homepage_content_1?></h3>
                                </div>
                                <div class="solu_description">
                                  <p>
                                    <?php echo $rows24->homepage_content_2?>
                                  </p>
                                  <button onclick="window.location.href='<?php echo $rows24->homepage_content_4?>'" type="button" class="read_more_btn">Read More</button>
