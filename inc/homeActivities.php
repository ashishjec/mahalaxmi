...
<section class="section" style="text-align:center; background-image: url('assets/img/bg13.png');" >
    ...
    <div class="container-fluid" style="text-align:center; margin-top: -100px;background-image: url('assets/img/home/<?php echo $rows46->homepage_content_7; ?>');">
...
You Are Here > <a href="index.php" style="color:#000;">Home</a> > <a style="color:#000;" href="index.php?page=<?php echo $page?>&id=<?php echo $id?>">Activity Detail</a>
</div>

    <div class="container" >
        <div class="row">
            <div class="col-md-12 shadow-lg p-5 mb-5 bg-white rounded" style="text-align:justify; color: #000; padding-top:30px; margin-top: 30px;">
